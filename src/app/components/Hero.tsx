...
export default function Hero() {
  return (
    <section
      className="relative flex flex-col items-center justify-center text-center min-h-[90vh] overflow-hidden bg-center bg-cover bg-fixed"
      style={{
        backgroundImage: "url('/security-bg.jpg')", // 🖼️ Replace with your actual image file in /public
      }}
    >
      ...
      <div className="relative z-10 px-6">
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-white/80 dark:text-white/70 leading-relaxed"
        >
