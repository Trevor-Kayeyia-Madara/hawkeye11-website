    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ClientLayout>
          ...
          <main className="bg-light dark:bg-dark text-black dark:text-white overflow-hidden relative transition-colors duration-700">
            {children}
            <ThemeToggle />
          </main>
          ...
          <Link
            ...
            className="fixed bottom-20 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition z-50"
